# -*- coding: utf-8 -*-
"""
Created on Thu Sep 14 14:28:38 2023
...
X_train, X_validate, y_train, y_validate = train_test_split(X, y, test_size=0.99, random_state=10)
tree_regr = DecisionTreeRegressor(min_samples_split=5) #new
...
tree_regr.fit(X_train, y_train) #new


bagged_regression_tree = BaggingRegressor(n_estimators = 100, base_estimator = DecisionTreeRegressor()) # new
...
print("MSE of bagged trees (brown):", mse(bagged_regression_tree, X_validate, y_validate)) #new
