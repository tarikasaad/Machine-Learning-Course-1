# -*- coding: utf-8 -*-
"""
Created on Thu Sep 14 15:21:24 2023
...
RF_regression = RandomForestRegressor(n_estimators = 100) # new
...
print("MSE of bagged trees (brown):", mse(bagged_regression_tree, X_validate, y_validate))
