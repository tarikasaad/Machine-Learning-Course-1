# -*- coding: utf-8 -*-
"""
Created on Sun Oct 15 15:49:06 2023

@author: 49163
"""

# Bagged Random Forest Model (Trial 10)
...
# Initialize and train the Random Forest classifier with bootstrapped samples
rf_classifier = RandomForestClassifier(n_estimators=100, random_state=42, bootstrap=True)
