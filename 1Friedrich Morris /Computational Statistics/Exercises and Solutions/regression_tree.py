...
from sklearn.tree import DecisionTreeRegressor #new
...
plt.plot(X_seq, tree_regr.predict(X_seq), color="yellow") #new
...
print("MSE of decision tree (yellow):", mse(tree_regr, X_validate, y_validate)) #new
