...
tree_regr = DecisionTreeRegressor(min_samples_leaf=5)
tree_regr.fit(X_train, y_train)

bagged_regression_tree = BaggingRegressor(estimator=DecisionTreeRegressor(min_samples_leaf=5), n_estimators=500)
bagged_regrression_tree.fit(X_train, y_train)
...
plt.plot(X_seq, RF_regression.predict(X_seq, color="violet"))
